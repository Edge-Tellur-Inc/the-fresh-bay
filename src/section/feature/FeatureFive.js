    ...
    >
      <Container>
        <Row className="align-items-center justify-content-between g-gs">
          ...
          <Col xl="5" lg="6">
            <TextBlock>
              <TitleH3 className="fw-medium mb-5">
                Make Your Website Growth
              </TitleH3>
              <div className="g-gs">
                ...
                <Service className="service-inline service-s6">
                  ...
                  <ServiceText>
                    ...
                    <p>
                      Slightly variations of passages available the majority
                      have suffered alteration even slightly believable.
                    </p>
                  </ServiceText>
                </Service>
                <Service className="service-inline service-s6">
        ...
        <Row className="justify-content-center text-center">
          <Col lg="8" md="10">
            <SectionHead>
              ...
              <p>Introducing Our App's Special Features</p>
            </SectionHead>
          </Col>
        </Row>
        <SectionContant>
