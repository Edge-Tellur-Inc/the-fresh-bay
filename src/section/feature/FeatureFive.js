                ...
                <Row className="justify-content-center text-center">
                    <Col lg="8" md="10">
                        <SectionHead>
                            ...
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Qui, suscipit. Unde nobis eius expedita quos?</p>
                        </SectionHead>
                    </Col>
                </Row>
                <SectionContant>
                                ...
                                <Col md="3" xs="6">
                                    <Card className="card-shadow service is-compact">
                                        <div className="card-inner">
                                            ...
                                            <ServiceText>
                                                <span className="title fs-14px">Colourful</span>
                                            </ServiceText>
                                        </div>
                                    </Card>
                                </Col>
                                <Col md="3" xs="6">
                                    <Card className="card-shadow service is-compact">
                                        <div className="card-inner">
                                            ...
                                            <ServiceText>
                                                <span className="title  fs-14px">Well Coded</span>
                                            </ServiceText>
                                        </div>
                                    </Card>
                                </Col>
                                <Col md="3" xs="6">
                                    <Card className="card-shadow service is-compact">
                                        <div className="card-inner">
                                            ...
                                            <ServiceText>
                                                <span className="title  fs-14px">Easy to Use</span>
                                            </ServiceText>
                                        </div>
                                    </Card>
                                </Col>
                                <Col md="3" xs="6">
                                    <Card className="card-shadow service is-compact">
                                        <div className="card-inner">
                                            ...
                                            <ServiceText>
                                                <span className="title  fs-14px">24/7 Support</span>
                                            </ServiceText>
                                        </div>
                                    </Card>
                                </Col>
